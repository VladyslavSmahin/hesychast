...
const ABOUT_DEFAULT = `ІЄСИХАСТ — православна крамниця, де кожен виріб зроблено з молитвою та любов'ю. Ми пропонуємо мед із власної пасіки, церковне начиння та православний мерч.
