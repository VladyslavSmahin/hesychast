...
export default function GlossaryPage() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <p className={s.hint}>
        Глосарій — назви/підписи блоків і текстів сайту (бейджі, заголовки блоків головної,
        пункти навігації, розділ «Про нас»). Порожнє поле = значення за замовчуванням.
        Категорії та товари змінюються у своїх розділах.
      </p>
